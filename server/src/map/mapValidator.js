...
// Replicate first two maps to populate 10 fallback slots
...
export function getFallbackMap(index) {
  ...
  for (let y = 0; y < size; y++) {
    for (let x = 0; x < size; x++) {
      ...
      // Assign biomes procedurally by grid zones for fallback maps
  ...
  // Ensure Exit Pos is placed in a neutral open cell if not explicitly defined in ASCII
